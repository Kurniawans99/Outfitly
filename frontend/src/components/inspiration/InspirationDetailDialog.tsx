...
import { Heart, Bookmark, Send, Plus, Loader2 } from "lucide-react";
...
const OutfitItem: React.FC<{ item: InspoItem }> = ({ item }) => (
  <div className="flex items-center gap-4 p-2 rounded-lg hover:bg-slate-50">
    ...
    {/* Tombol Simpan ke Wardrobe bisa diimplementasikan nanti jika perlu */}
  </div>
);
...
export const InspirationDetailV2: React.FC<InspirationDetailV2Props> = ({
  ...
  const currentUserId = localStorage.getItem("userId") || ""; // Ambil ID user dari local storage
